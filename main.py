...
- Fixed stock issues, font errors, order saving errors, JobQueue issue, SyntaxError, and IndentationError
- Enhanced error handling for webhook and lifespan
